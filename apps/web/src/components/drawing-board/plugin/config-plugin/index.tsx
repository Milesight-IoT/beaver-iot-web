import React, { useRef, Suspense, useEffect, useMemo, useContext } from 'react';
...
const ConfigPlugin = (props: ConfigPluginProps) => {
    ...
    const panelMountedRef = useRef<HTMLDivElement>(null);
    ...
    return (
        <DrawingBoardContext.Provider value={newContext}>
            <Modal
            ...
            >
                <div className="config-plugin-container">
                    ...
                    <div className="config-plugin-container-right">
                        ...
                        {/* To mounted drawer or modal */}
                        <div
                            ref={panelMountedRef}
                            className="config-plugin-container-right__mounted"
                        />
                    </div>
                </div>
            </Modal>
